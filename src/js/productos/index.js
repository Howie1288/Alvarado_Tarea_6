...
const guardar = async (e) => {
    ...
    const url = '/Alvarado_Tarea_6/controladores/productos/index.php';
    const config = {
        method : 'POST',
        body
    }
...
const buscar = async () => {
    ...
    const url = `/Alvarado_Tarea_6/controladores/productos/index.php?producto_nombre=${producto_nombre}&producto_precio=${producto_precio}`;
    const config = {
        method : 'GET'
    }
...
const eliminar = async (id) => {
    if(confirm("¿Desea eliminar este producto?")){
        ...
        const url = `/Alvarado_Tarea_6/controladores/productos/index.php?tipo=1&producto_id=${id}`;
        const config = {
            method : 'GET'
        }
